...
public class EmploymentRegistrationForm extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            ...
            String query = "INSERT INTO employees (name, email, gender, education, experience, skills) VALUES ('" + name + "', '" + email + "', '" + gender + "', '" + education + "', '" + experience + "', '" + skills + "')";
